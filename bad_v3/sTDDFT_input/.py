...
df_acc = pd.read_csv('/ihome/ghutchison/blp62/GA/running_GA/sequence/unit_csvs/acc_left_term_with_homo_v3.csv')
df_don = pd.read_csv('/ihome/ghutchison/blp62/GA/running_GA/sequence/unit_csvs/don_left_term_with_homo_v3.csv')
...
def sequence(new_df):
    ...
    #orig_seq = new_df[new_df.columns[-1]]
    print(orig_seq)
...
def get_freq_counts(df):
    ...
    return [count_seq, count_sym]

run_data = pd.read_csv(path, index_col=False)

counts = get_freq_counts(run_data)
print(counts)
'''unit_freq(run_data)
...
plt.savefig('seq_frequency.pdf', transparent=False, bbox_inches='tight') 
plt.savefig('seq_frequency.png', transparent=False, bbox_inches='tight')
...
plt.savefig('sym_frequency.pdf', transparent=False, bbox_inches='tight') 
plt.savefig('sym_frequency.png', transparent=False, bbox_inches='tight')'''