...
def init_freq_lists(smiles_list):
    ...
    with open('/ihome/ghutchison/blp62/GA/running_GA/frequency_lists/freq_acc_term.csv', 'w') as freq_acc_term:
    ...
    with open('/ihome/ghutchison/blp62/GA/running_GA/frequency_lists/freq_acc_core.csv', 'w') as freq_acc_core:
        fieldnames = ['index', 'SMILES', 'frequency']
    ...
    with open('/ihome/ghutchison/blp62/GA/running_GA/frequency_lists/freq_don_core.csv', 'w') as freq_don_core:
        fieldnames = ['index', 'SMILES', 'frequency']
...
def update_frequency_list(unit_type, index):
    ...
    if unit_type == 'acc_term':
        unit_csv = "/ihome/ghutchison/blp62/GA/running_GA/frequency_lists/freq_acc_term.csv"

    elif unit_type =='acc_core':
        unit_csv = "/ihome/ghutchison/blp62/GA/running_GA/frequency_lists/freq_acc_core.csv"

    elif unit_type == 'don_core':
        unit_csv = "/ihome/ghutchison/blp62/GA/running_GA/frequency_lists/freq_don_core.csv"
