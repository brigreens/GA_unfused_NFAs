...
df_acc_term = pd.read_csv('/ihome/ghutchison/blp62/GA/running_GA/more_units/unit_csvs/acc_left_term_with_homo.csv')
df_don_core = pd.read_csv('/ihome/ghutchison/blp62/GA/running_GA/more_units/unit_csvs/don_core_with_homo.csv')
df_acc_core = pd.read_csv('/ihome/ghutchison/blp62/GA/running_GA/more_units/unit_csvs/acc_core_with_homo.csv')
...
def find_homo(unit_index, row, new_df, unit_AD):
        ...
        if unit_AD == '1':
            homo = df_acc_term['homo'][unit]
        elif unit_AD == '0':
            homo = df_don_core['homo'][unit]
        elif unit_AD ==  '3':
            homo = df_acc_core['homo'][unit]
...
def split_filename(df):
    '''
    Takes the full_analysis_data and adds a column for sequence 
    Parameters
    --------
    df: dataframe
    ...
    -------
    df2: dataframe
        new dataframe with sequence added
    '''
...
plt.savefig('seq_frequency_v2.pdf', transparent=False, bbox_inches='tight') 
plt.savefig('seq_frequency_v2.png', transparent=False, bbox_inches='tight')
