...
def make_unit_list():
    ...
    with open("/ihome/ghutchison/blp62/GA/running_GA/v5/unit_csvs/acc_core_v5.csv", "r", encoding='utf-8') as csv_file:
        csv_reader = csv.reader(csv_file, delimiter=',')
        next(csv_reader)
        for row in csv_reader:
            acc_core.append(row[1])

    with open("/ihome/ghutchison/blp62/GA/running_GA/v5/unit_csvs/acc_left_term_v5.csv", "r", encoding='utf-8') as csv_file:
        csv_reader = csv.reader(csv_file, delimiter=',')
        next(csv_reader)
        for row in csv_reader:
            acc_term_L.append(row[1])

    with open("/ihome/ghutchison/blp62/GA/running_GA/v5/unit_csvs/acc_right_term_v5.csv", "r", encoding='utf-8') as csv_file:
        csv_reader = csv.reader(csv_file, delimiter=',')
        next(csv_reader)
        for row in csv_reader:
            acc_term_R.append(row[1])

    with open("/ihome/ghutchison/blp62/GA/running_GA/v5/unit_csvs/don_core_v5.csv", "r", encoding='utf-8') as csv_file:
        csv_reader = csv.reader(csv_file, delimiter=',')
        next(csv_reader)
        for row in csv_reader:
            don_core.append(row[1])

    with open("/ihome/ghutchison/blp62/GA/running_GA/v5/unit_csvs/don_left_term_v5.csv", "r", encoding='utf-8') as csv_file:
        csv_reader = csv.reader(csv_file, delimiter=',')
        next(csv_reader)
        for row in csv_reader:
            don_term_L.append(row[1])

    with open("/ihome/ghutchison/blp62/GA/running_GA/v5/unit_csvs/don_right_term_v5.csv", "r", encoding='utf-8') as csv_file:
        csv_reader = csv.reader(csv_file, delimiter=',')
        next(csv_reader)
        for row in csv_reader:
...
def parse_sTDDFT(file_name):
    ...
    '''
    path_name = '/ihome/ghutchison/blp62/GA/running_GA/v5/sTDDFT_output/%s.out' % (file_name)
