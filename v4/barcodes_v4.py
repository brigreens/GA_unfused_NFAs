...
df_acc = pd.read_csv('/ihome/ghutchison/blp62/GA/running_GA/opt_GA/unit_csvs/acc_left_term_with_homo.csv')
df_don = pd.read_csv('/ihome/ghutchison/blp62/GA/running_GA/opt_GA/unit_csvs/don_core_with_homo.csv')
...
gs = fig.add_gridspec(ncols = 6, nrows = 25)
...
ax_9 = fig.add_subplot(gs[9, :-1])
ax_10 = fig.add_subplot(gs[10, :-1])
ax_11= fig.add_subplot(gs[11, :-1])
ax_12= fig.add_subplot(gs[12, :-1])
ax_13 = fig.add_subplot(gs[13, :-1])
ax_14= fig.add_subplot(gs[14, :-1])
ax_15= fig.add_subplot(gs[15, :-1])
ax_16= fig.add_subplot(gs[16, :-1])
ax_17= fig.add_subplot(gs[17, :-1])
ax_18= fig.add_subplot(gs[18, :-1])
ax_19= fig.add_subplot(gs[19, :-1])
ax_20= fig.add_subplot(gs[20, :-1])
ax_21= fig.add_subplot(gs[21, :-1])
ax_22= fig.add_subplot(gs[22, :-1])
ax_23= fig.add_subplot(gs[23, :-1])
ax_24= fig.add_subplot(gs[24, :-1])

ax_25 = fig.add_subplot(gs[5:20, -1])'''
...
top_NFAs = pd.read_csv('/ihome/ghutchison/blp62/GA/running_GA/opt_GA/top_over20.csv')
...
#colbar = mpl.colorbar.ColorbarBase(ax_25, cmap='bwr_r', norm=MidpointNormalize(midpoint=-6.5467, vmin=-8.89652, vmax = -3.73493), orientation='horizontal')
#colbar.set_label('HOMO (eV)', fontsize=16)
#colbar.ax.tick_params(labelsize=16)
# thipohene HOMO is -6.5467
# blue is donor, red is acceptor

plt.savefig('barcode_v4.png')
plt.savefig('barcode_v4.pdf')