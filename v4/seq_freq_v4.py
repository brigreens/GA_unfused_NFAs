...
plt.savefig('seq_frequency_v4.pdf', transparent=False, bbox_inches='tight') 
plt.savefig('seq_frequency_v4.png', transparent=False, bbox_inches='tight')
...
plt.savefig('sym_frequency_v4.pdf', transparent=False, bbox_inches='tight') 
plt.savefig('sym_frequency_v4.png', transparent=False, bbox_inches='tight')